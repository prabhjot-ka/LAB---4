...
async function populate() {
    ...
    // STEP 4c: Extend the JSON object to include two more flavors of ice cream
    responseJson.topFlavors.push(
        {
            name: "Chocolate Fudge",
            calories: 300,
            type: "Fudge",
            ingredients: ["Chocolate", "Fudge", "Sugar", "Cream"],
            image: "images/ice-cream-xtra1.svg"
        },
        {
            name: "Vanilla Bean",
            calories: 200,
            type: "Classic",
            ingredients: ["Vanilla", "Bean", "Sugar", "Cream"],
            image: "images/ice-cream-xtra2.svg"
        }
    );
